...
| **US-01** | Registrar usuario | Como administrador, quiero registrar nuevos usuarios, para permitir que el personal autorizado acceda a la plataforma. | **Dado que** el administrador cuenta con permisos de gestión de usuarios. **Cuando** registra los datos obligatorios de un nuevo usuario. **Entonces** el sistema crea la cuenta y confirma su registro. **Y** el sistema informa si existe un dato inválido o duplicado. | EP-01 |
| **US-02** | Iniciar sesión | Como administrador, técnico u operador, quiero iniciar sesión, para acceder a las funciones permitidas según mi rol. | **Dado que** el usuario tiene una cuenta registrada. **Cuando** ingresa credenciales válidas. **Entonces** el sistema autentica al usuario y permite el acceso. **Cuando** las credenciales son incorrectas. **Entonces** el sistema rechaza el acceso e informa el error. | EP-01 |
| **US-03** | Gestionar roles y permisos | Como administrador, quiero asignar roles y permisos a los usuarios, para controlar el acceso a las funcionalidades de la plataforma. | **Dado que** el administrador tiene permisos para gestionar usuarios. **Cuando** asigna o modifica el rol de un usuario. **Entonces** el sistema actualiza sus permisos. **Y** el usuario solo puede acceder a las funcionalidades correspondientes a su rol. | EP-01 |
| **US-04** | Gestionar perfil | Como administrador, técnico u operador, quiero actualizar la información de mi perfil, para mantener mis datos personales y laborales actualizados. | **Dado que** el usuario ha iniciado sesión. **Cuando** modifica sus datos permitidos y guarda los cambios. **Entonces** el sistema actualiza la información del perfil. **Y** el sistema informa si algún dato no cumple con el formato requerido. | EP-01 |
...
| **US-05** | Registrar recepción de materia prima | Como operador, quiero registrar la recepción de arroz cáscara, para mantener un control de la materia prima que ingresa al molino. | **Dado que** el operador tiene permisos para registrar materia prima. **Cuando** ingresa los datos de recepción, como fecha, proveedor, cantidad y procedencia. **Entonces** el sistema registra la recepción. **Y** el sistema asigna un identificador único al registro. | EP-02 |
| **US-06** | Registrar lote de materia prima | Como operador, quiero registrar lotes de materia prima, para facilitar la trazabilidad del arroz durante el proceso productivo. | **Dado que** existe una recepción de materia prima registrada. **Cuando** el operador registra los datos del lote. **Entonces** el sistema crea el lote y lo relaciona con la recepción correspondiente. **Y** el sistema evita la duplicidad del identificador del lote. | EP-02 |
| **US-07** | Registrar información de producción | Como operador, quiero registrar la información de cada proceso productivo, para mantener actualizado el seguimiento de la producción del molino. | **Dado que** existe un lote de materia prima registrado. **Cuando** el operador registra los datos del proceso productivo. **Entonces** el sistema guarda la información de producción. **Y** el registro queda relacionado con el lote correspondiente. | EP-02 |
| **US-08** | Consultar procesos productivos | Como operador, quiero consultar los procesos productivos registrados, para conocer el estado y la información de las operaciones realizadas. | **Dado que** existen procesos productivos registrados. **Cuando** el operador solicita consultar los procesos. **Entonces** el sistema muestra los registros disponibles. **Y** el operador puede identificar el lote, la fecha y el estado del proceso. | EP-02 |
| **US-09** | Consultar historial de producción | Como administrador, quiero consultar el historial de producción, para analizar el comportamiento de las operaciones realizadas en el molino. | **Dado que** existen registros históricos de producción. **Cuando** el administrador solicita el historial. **Entonces** el sistema muestra la información registrada. **Y** permite consultar los datos según criterios como fecha, lote o proceso. | EP-02 |
| **US-10** | Actualizar información de producción | Como operador, quiero actualizar la información de un proceso productivo, para corregir datos registrados y mantener la información precisa. | **Dado que** existe un registro de producción y el operador tiene permisos de edición. **Cuando** modifica los datos permitidos. **Entonces** el sistema actualiza el registro. **Y** el sistema conserva la relación con el lote correspondiente. | EP-02 |
...
| **US-11** | Registrar resultados de calidad | Como operador, quiero registrar los resultados de calidad del arroz procesado, para mantener un control sobre las características del producto obtenido. | **Dado que** existe un proceso productivo registrado. **Cuando** el operador ingresa los resultados de calidad. **Entonces** el sistema guarda los valores registrados. **Y** los resultados quedan relacionados con el proceso o lote correspondiente. | EP-03 |
| **US-12** | Consultar indicadores de rendimiento | Como administrador, quiero consultar los indicadores de rendimiento, para evaluar la eficiencia de la producción del molino. | **Dado que** existen datos de producción registrados. **Cuando** el administrador solicita los indicadores de rendimiento. **Entonces** el sistema calcula y muestra los indicadores disponibles. **Y** los resultados corresponden al periodo o proceso seleccionado. | EP-03 |
| **US-13** | Consultar porcentaje de arroz entero y quebrado | Como operador, quiero consultar el porcentaje de arroz entero y quebrado, para conocer la composición del producto obtenido durante el procesamiento. | **Dado que** existen resultados de calidad registrados. **Cuando** el operador consulta la composición del arroz procesado. **Entonces** el sistema muestra los porcentajes de arroz entero y quebrado. **Y** los valores corresponden al lote o proceso seleccionado. | EP-03 |
| **US-14** | Registrar y consultar merma | Como operador, quiero registrar y consultar la merma generada durante la producción, para identificar las pérdidas de materia prima y producto. | **Dado que** existe un proceso productivo registrado. **Cuando** el operador registra la cantidad de merma. **Entonces** el sistema guarda el registro y calcula el porcentaje correspondiente cuando existan datos suficientes. **Y** el operador puede consultar la merma asociada al proceso. | EP-03 |
| **US-15** | Comparar indicadores de calidad | Como administrador, quiero comparar indicadores de calidad entre diferentes periodos o lotes, para identificar cambios en los resultados productivos. | **Dado que** existen indicadores de calidad de dos o más periodos o lotes. **Cuando** el administrador solicita una comparación. **Entonces** el sistema muestra los valores correspondientes. **Y** permite identificar las diferencias entre los registros seleccionados. | EP-03 |
| **US-16** | Identificar desviaciones de calidad y rendimiento | Como administrador, quiero identificar desviaciones en los indicadores de calidad y rendimiento, para detectar resultados que requieran una revisión operativa. | **Dado que** existen indicadores registrados y valores de referencia definidos. **Cuando** un indicador supera o se encuentra por debajo del rango esperado. **Entonces** el sistema identifica la desviación. **Y** el sistema muestra el indicador y el valor que presenta la desviación. | EP-03 |
...
| **US-17** | Registrar maquinaria | Como técnico, quiero registrar las máquinas del molino, para mantener un inventario actualizado de los equipos operativos. | **Dado que** el técnico tiene permisos para gestionar maquinaria. **Cuando** registra los datos de una máquina. **Entonces** el sistema guarda la información del equipo. **Y** el sistema asigna o valida un identificador único para la máquina. | EP-04 |
| **US-18** | Consultar estado de maquinaria | Como técnico, quiero consultar el estado de las máquinas, para conocer su condición operativa y detectar posibles necesidades de atención. | **Dado que** existen máquinas registradas. **Cuando** el técnico consulta el estado de una máquina. **Entonces** el sistema muestra su estado operativo registrado. **Y** la información corresponde a la última actualización disponible. | EP-04 |
| **US-19** | Registrar mantenimiento preventivo | Como técnico, quiero registrar actividades de mantenimiento preventivo, para reducir la probabilidad de fallas en las máquinas. | **Dado que** existe una máquina registrada. **Cuando** el técnico registra una actividad de mantenimiento preventivo. **Entonces** el sistema guarda la actividad, la fecha, la máquina y las observaciones correspondientes. **Y** el mantenimiento queda asociado al historial del equipo. | EP-04 |
| **US-20** | Registrar mantenimiento correctivo | Como técnico, quiero registrar actividades de mantenimiento correctivo, para documentar las acciones realizadas después de una falla o avería. | **Dado que** existe una máquina registrada y una incidencia o falla identificada. **Cuando** el técnico registra el mantenimiento correctivo. **Entonces** el sistema guarda la actividad realizada y los datos de la intervención. **Y** el registro queda asociado a la máquina correspondiente. | EP-04 |
| **US-21** | Consultar historial de mantenimiento | Como técnico, quiero consultar el historial de mantenimiento de una máquina, para conocer las intervenciones realizadas y apoyar futuras decisiones técnicas. | **Dado que** una máquina tiene actividades de mantenimiento registradas. **Cuando** el técnico consulta su historial. **Entonces** el sistema muestra las actividades asociadas. **Y** cada registro incluye información como tipo, fecha, descripción y responsable. | EP-04 |
...
| **US-22** | Consultar variables operativas | Como técnico, quiero consultar las variables operativas de las máquinas, para supervisar su comportamiento durante la producción. | **Dado que** existen datos operativos registrados o recibidos de una máquina. **Cuando** el técnico consulta sus variables. **Entonces** el sistema muestra los valores disponibles. **Y** cada valor se relaciona con la máquina y el momento de registro correspondiente. | EP-05 |
| **US-23** | Detectar anomalías operativas | Como técnico, quiero detectar anomalías en las variables de las máquinas, para identificar comportamientos que puedan indicar una posible falla. | **Dado que** existen datos operativos y criterios de evaluación definidos. **Cuando** una variable presenta un comportamiento fuera del rango esperado. **Entonces** el sistema identifica una anomalía. **Y** el sistema registra la variable, el valor detectado y la fecha del evento. | EP-05 |
| **US-24** | Consultar alertas | Como técnico, quiero consultar las alertas generadas, para conocer las anomalías que requieren revisión o atención. | **Dado que** el sistema ha generado alertas. **Cuando** el técnico consulta las alertas. **Entonces** el sistema muestra las alertas disponibles. **Y** cada alerta incluye información sobre la máquina, el evento, la prioridad y el estado de atención. | EP-05 |
| **US-25** | Consultar historial de anomalías | Como técnico, quiero consultar el historial de anomalías, para analizar eventos anteriores y reconocer patrones de comportamiento en las máquinas. | **Dado que** existen anomalías registradas. **Cuando** el técnico consulta el historial. **Entonces** el sistema muestra los eventos registrados. **Y** permite identificar la fecha, la máquina, la variable afectada y el estado de la anomalía. | EP-05 |
| **US-26** | Consultar recomendaciones de mantenimiento | Como técnico, quiero consultar recomendaciones de mantenimiento, para priorizar acciones preventivas según las anomalías detectadas. | **Dado que** existen anomalías o indicadores que requieren atención. **Cuando** el técnico consulta las recomendaciones. **Entonces** el sistema muestra las acciones sugeridas. **Y** cada recomendación se relaciona con la máquina o evento correspondiente. | EP-05 |
...
| **US-27** | Consultar resumen operativo | Como administrador, quiero consultar un resumen operativo del molino, para conocer el estado general de la producción, la calidad y el mantenimiento. | **Dado que** existen datos registrados en la plataforma. **Cuando** el administrador consulta el resumen operativo. **Entonces** el sistema muestra los principales indicadores disponibles. **Y** la información corresponde al periodo seleccionado o al último periodo registrado. | EP-06 |
| **US-28** | Generar reportes de producción | Como administrador, quiero generar reportes de producción, para analizar el volumen procesado, el rendimiento y la merma del molino. | **Dado que** existen registros de producción. **Cuando** el administrador solicita un reporte de producción para un periodo determinado. **Entonces** el sistema genera el reporte con los datos disponibles. **Y** el reporte incluye los indicadores relacionados con la producción. | EP-06 |
| **US-29** | Generar reportes de mantenimiento | Como administrador, quiero generar reportes de mantenimiento, para evaluar las actividades realizadas y el comportamiento de las máquinas. | **Dado que** existen registros de mantenimiento. **Cuando** el administrador solicita un reporte de mantenimiento. **Entonces** el sistema genera el reporte correspondiente. **Y** el reporte incluye información como máquina, tipo de mantenimiento, fecha y estado. | EP-06 |
| **US-30** | Analizar tendencias operativas | Como administrador, quiero analizar las tendencias de los indicadores operativos, para identificar comportamientos recurrentes y oportunidades de mejora. | **Dado que** existen datos históricos suficientes. **Cuando** el administrador consulta las tendencias de un indicador. **Entonces** el sistema muestra la evolución del indicador durante el periodo seleccionado. **Y** permite reconocer aumentos, disminuciones o variaciones relevantes. | EP-06 |
...
| **US-31** | Conocer la propuesta de valor | Como visitante, quiero conocer la propuesta de valor de Molinex, para comprender cómo la plataforma ayuda a mejorar la gestión operativa de los molinos de arroz. | **Dado que** el visitante accede a la Landing Page. **Cuando** consulta la sección de propuesta de valor. **Entonces** el sistema presenta una explicación clara del problema que resuelve Molinex y de su beneficio principal. | EP-07 |
| **US-32** | Conocer las funcionalidades | Como visitante, quiero conocer las funcionalidades de Molinex, para identificar las herramientas que ofrece la plataforma. | **Dado que** el visitante accede a la Landing Page. **Cuando** consulta la sección de funcionalidades. **Entonces** el sistema muestra las principales capacidades de Molinex. **Y** cada funcionalidad presenta una descripción comprensible de su utilidad. | EP-07 |
| **US-33** | Consultar planes de suscripción | Como visitante, quiero consultar los planes de suscripción, para conocer las alternativas comerciales disponibles para contratar Molinex. | **Dado que** existen planes de suscripción configurados. **Cuando** el visitante consulta la sección de planes. **Entonces** el sistema muestra los planes disponibles. **Y** cada plan presenta su nombre, precio, características y condiciones principales. | EP-07 |
| **US-34** | Identificar el plan adecuado | Como visitante, quiero comparar los planes de suscripción, para identificar cuál se adapta mejor a las necesidades de mi empresa. | **Dado que** el visitante puede consultar los planes disponibles. **Cuando** compara sus características y precios. **Entonces** el sistema presenta la información de cada plan de manera diferenciada. **Y** el visitante puede reconocer las funciones incluidas en cada alternativa. | EP-07 |
| **US-35** | Conocer los beneficios de Molinex | Como visitante, quiero conocer los beneficios de utilizar Molinex, para evaluar el valor que la plataforma puede aportar a mi empresa. | **Dado que** el visitante accede a la Landing Page. **Cuando** consulta la sección de beneficios. **Entonces** el sistema presenta beneficios relacionados con el control de producción, la reducción de pérdidas, el mantenimiento y la toma de decisiones. | EP-07 |
| **US-36** | Solicitar información comercial | Como visitante interesado, quiero solicitar información comercial sobre Molinex, para recibir orientación sobre la plataforma y sus planes de suscripción. | **Dado que** el visitante desea obtener información comercial. **Cuando** registra sus datos de contacto y su consulta. **Entonces** el sistema valida la información y registra la solicitud. **Y** el sistema confirma que la solicitud fue recibida correctamente. | EP-07 |
...
| **TS-01** | Gestionar recursos de producción mediante API | Como desarrollador, quiero implementar endpoints RESTful para gestionar los recursos de producción, para permitir que los clientes autorizados registren, consulten y actualicen información productiva. | **Dado que** el servicio API está disponible. **Cuando** un cliente autorizado envía una solicitud válida para crear un recurso de producción. **Entonces** la API registra el recurso y responde con el código HTTP **201**. **Cuando** el cliente consulta un recurso existente. **Entonces** la API responde con el código HTTP **200** y devuelve la información solicitada. **Cuando** la solicitud contiene datos inválidos. **Entonces** la API responde con el código HTTP **400**. | EP-08 |
| **TS-02** | Consultar indicadores mediante API | Como desarrollador, quiero implementar endpoints RESTful para consultar indicadores de rendimiento, calidad y merma, para permitir que los clientes autorizados obtengan información operativa procesada. | **Dado que** existen datos suficientes para calcular los indicadores. **Cuando** un cliente autorizado solicita los indicadores mediante la API. **Entonces** la API responde con el código HTTP **200** y devuelve los valores calculados. **Cuando** el recurso solicitado no existe. **Entonces** la API responde con el código HTTP **404**. **Cuando** el cliente no cuenta con autorización. **Entonces** la API responde con el código HTTP **401** o **403**, según corresponda. | EP-08 |
| **TS-03** | Gestionar mantenimiento mediante API | Como desarrollador, quiero implementar endpoints RESTful para gestionar los registros de mantenimiento, para permitir que los clientes autorizados registren y consulten las actividades realizadas en las máquinas. | **Dado que** existe una máquina registrada. **Cuando** un cliente autorizado envía una solicitud válida para registrar una actividad de mantenimiento. **Entonces** la API guarda el registro y responde con el código HTTP **201**. **Cuando** el cliente consulta el historial de mantenimiento de una máquina existente. **Entonces** la API responde con el código HTTP **200** y devuelve los registros correspondientes. **Cuando** la máquina no existe. **Entonces** la API responde con el código HTTP **404**. | EP-08 |
| **TS-04** | Gestionar anomalías y alertas mediante API | Como desarrollador, quiero implementar endpoints RESTful para gestionar anomalías y alertas, para permitir que los clientes autorizados consulten y actualicen los eventos detectados. | **Dado que** existen anomalías registradas. **Cuando** un cliente autorizado consulta las anomalías o alertas mediante la API. **Entonces** la API responde con el código HTTP **200** y devuelve la información solicitada. **Cuando** el cliente actualiza el estado de una alerta con datos válidos. **Entonces** la API actualiza el recurso y responde con el código HTTP **200**. **Cuando** la alerta no existe. **Entonces** la API responde con el código HTTP **404**. **Cuando** el cliente no está autorizado. **Entonces** la API responde con el código HTTP **401** o **403**, según corresponda. | EP-08 |
